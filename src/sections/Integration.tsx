...
const paths = [
  'M 206 76 H 326 C 400 76 402 220 514 270',
  'M 206 218 H 330 C 410 218 420 252 514 278',
  'M 206 360 H 330 C 410 360 420 316 514 292',
  'M 206 502 H 330 C 410 502 412 354 514 300',
